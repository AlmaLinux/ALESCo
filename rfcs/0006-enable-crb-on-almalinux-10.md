...
With EPEL 10, `epel-release` will grow a conditional dependency on `selinux-policy-extra` that is [shipped in CRB](https://gitlab.com/redhat/centos-stream/rpms/selinux-policy/-/merge_requests/197),
